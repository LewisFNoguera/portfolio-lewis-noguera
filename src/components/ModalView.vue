<template>
  <transition name="modal-fade">
    <div
      v-if="isModalVisible"
      class="fixed top-0 bottom-0 left-0 right-0 flex justify-center items-center bg-black/80 z-[99999] overflow-auto"
    >
      <div
      ...
      >
        <div>
            ...
            <div class="text-left p-5">
              ...
              <div class="mt-8">
                <a
                  ...
                  target="_blank"
                  class="mr-4 flex-1 px-6 py-2 font-semibold select-none rounded-md text-[#E85F87] border border-white bg-indigo-50 hover:bg-gray-50"
                  >Code</a
                >
                ...
                <a
                  ...
                  target="_blank"
                  class="flex-1 px-6 py-2 font-semibold select-none rounded-md text-blue-600 border border-white bg-indigo-50 hover:bg-gray-50"
                  >Live Project</a
                >
              </div>
              ...
              <div class="mt-8">
                <div class="flex flex-wrap items-center justify-center">
                  <div
                    v-if="project?.ui"
                    class="flex-1 px-6 py-2 font-semibold select-none rounded-md text-blue-600 border border-white bg-gray-50"
                  >
                    <p class="text-sm text-gray-500 m-2">UI Design:</p>
          ...
          <div class="flex items-center justify-end flex-row p-3">
            <!-- <hr class="py-2 border-gray-50/10" /> -->
            <button
              @click="openModal"
